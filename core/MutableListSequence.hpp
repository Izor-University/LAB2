...
protected:
    virtual ListSequence<T>* Instance() override { return this; }
...
public:
    ...
    public:
        Builder() { seq = new MutableListSequence<T>(); }
    ...
    virtual Sequence<T>* create_empty() const override { return new MutableListSequence<T>(); }
    virtual Sequence<T>* clone() const override { return new MutableListSequence<T>(*this); }
